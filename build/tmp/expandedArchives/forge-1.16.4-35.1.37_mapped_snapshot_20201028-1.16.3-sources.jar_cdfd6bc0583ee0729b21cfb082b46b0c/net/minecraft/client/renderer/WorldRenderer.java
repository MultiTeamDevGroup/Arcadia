...
public class WorldRenderer implements IResourceManagerReloadListener, AutoCloseable {
   ...
   private void renderRainSnow(LightTexture lightmapIn, float partialTicks, double xIn, double yIn, double zIn) {
      net.minecraftforge.client.IWeatherRenderHandler renderHandler = world.func_239132_a_().getWeatherRenderHandler();
      if (renderHandler != null) {
         renderHandler.render(ticks, partialTicks, world, mc, lightmapIn, xIn, yIn, zIn);
         return;
      }
   ...
   public void addRainParticles(ActiveRenderInfo activeRenderInfoIn) {
      net.minecraftforge.client.IWeatherParticleRenderHandler renderHandler = world.func_239132_a_().getWeatherParticleRenderHandler();
      if (renderHandler != null) {
         renderHandler.render(ticks, world, mc, activeRenderInfoIn);
         return;
      }
   ...
   public void renderSky(MatrixStack matrixStackIn, float partialTicks) {
      net.minecraftforge.client.ISkyRenderHandler renderHandler = world.func_239132_a_().getSkyRenderHandler();
      if (renderHandler != null) {
         renderHandler.render(ticks, partialTicks, matrixStackIn, world, mc);
         return;
      }
   ...
   public void renderClouds(MatrixStack matrixStackIn, float partialTicks, double viewEntityX, double viewEntityY, double viewEntityZ) {
      net.minecraftforge.client.ICloudRenderHandler renderHandler = world.func_239132_a_().getCloudRenderHandler();
      if (renderHandler != null) {
         renderHandler.render(ticks, partialTicks, matrixStackIn, world, mc, viewEntityX, viewEntityY, viewEntityZ);
         return;
      }
   ...
   private void updateChunks(long finishTimeNano) {
      ...
      if (!this.chunksToUpdate.isEmpty()) {
         ...
         while(iterator.hasNext()) {
            ...
            if (!net.minecraftforge.common.ForgeConfig.CLIENT.alwaysSetupTerrainOffThread.get() && chunkrenderdispatcher$chunkrender.needsImmediateUpdate()) {
