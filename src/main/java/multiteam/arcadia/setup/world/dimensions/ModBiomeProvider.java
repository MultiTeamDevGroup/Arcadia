...
public class ModBiomeProvider extends BiomeProvider {
    ...
    public static final Codec<ModBiomeProvider> CODEC = RegistryLookupCodec.getLookUpCodec(Registry.BIOME_KEY).xmap(ModBiomeProvider::new, ModBiomeProvider::getBiomeRegistry).codec();
