...
public class ModItems {
    ...
    public static final RegistryObject<Item> BOTTLED_ZAP = Registration.ITEMS.register("bottled_zap", () -> new BottledZap(new Item.Properties().tab(ArcadiaMod.ARCADIA_MAIN_TAB)));
    ...
    public static final RegistryObject<Item> TESTCURIO = Registration.ITEMS.register("test_curio", () -> new TestCurio(new Item.Properties()));
