...
public class Registration {
    ...
    public static final DeferredRegister<ParticleType<?>> PARTICLE_TYPES = DeferredRegister.create(ForgeRegistries.PARTICLE_TYPES, Arcadia.MODID);
    ...
    public static void register(){
        ...
        PARTICLE_TYPES.register(modeEventBus);

        ModBlockRegistry.register();
        ModItemRegistry.register();
        //ModPotions.register();
        //ModEntities.register();
        ModParticleRegistry.register();
    }
}
